...
def s_prediction_batch(student_model):
  x_train, _, x_test, _, _, y_test = load_imdb.load_imdb(35_000)
...
def t_prediction_batch(teacher_model):
  _, _, x_test_new, _, _, y_test_new = load_imdb.load_imdb(35_000)
  x_train, _, _, _, _, _ = load_imdb.load_imdb()
