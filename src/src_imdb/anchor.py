...
def anchor(teacher_model, old_data, new_data, alpha):
  x_train_new, _, _, y_train_new, _, _ = load_data_train_split.load_data_train_split(new_data)
  ...
  train_val.train_and_test_model_with_hparams(new_data,
                                              org_hyperparams, 
                                              f"lstm_student_alpha_{alpha}",
                                              distil=np.array(dist))
